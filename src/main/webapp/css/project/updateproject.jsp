...
<form id="floatleft" action="/project/update" method="post">
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="project" name="projectid" value=<%=u.getProjectid()%>>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input
			type="text" id="user" name="userid" value=<%=u.getUserid()%>> 
    </div>
  </div>
  <div class="row">
    <div class="col-25">
   ...
   <div class="col-75">
      <input
			type="text" id="projectname" name="projectname" value=<%=u.getProjectname()%>> 
    </div>
  </div>
